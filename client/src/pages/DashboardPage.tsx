                ...
                <div className="space-y-1.5">
                  ...
                  <div className="grid grid-cols-3 gap-1 text-[10px]">
                    <div className="bg-muted/30 rounded py-2 px-2 text-center flex flex-col justify-center items-center gap-0.5">
                      ...
                      <p className="font-medium text-[10px] leading-none line-clamp-1">{note.clientName || 'N/A'}</p>
                    </div>
                    <div className="bg-muted/30 rounded py-2 px-2 text-center flex flex-col justify-center items-center gap-0.5">
                    ...
                    <div className="bg-muted/30 rounded py-2 px-2 text-center flex flex-col justify-center items-center gap-0.5">
                      <p className="text-muted-foreground text-[9px] font-semibold leading-none">TRABAJADOR</p>
                      <p className="font-medium text-[10px] leading-none line-clamp-1">{note.workerName || 'Desconocido'}</p>
                    </div>
                    <div className="bg-muted/30 rounded py-2 px-2 text-center flex flex-col justify-center items-center gap-0.5">
