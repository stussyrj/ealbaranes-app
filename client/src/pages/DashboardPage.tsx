                ...
                <div className="space-y-1.5">
                  ...
                  <div className="grid grid-cols-3 gap-1 text-[10px]">
                    <div className="bg-muted/30 rounded px-2 grid min-h-[40px] place-content-center text-center gap-0.5">
                      ...
                      <span className="font-medium text-[10px] leading-tight line-clamp-1">{note.clientName || 'N/A'}</span>
                    </div>
                    <div className="bg-muted/30 rounded px-2 grid min-h-[40px] place-content-center text-center gap-0.5">
                    ...
                    <div className="bg-muted/30 rounded px-2 grid min-h-[40px] place-content-center text-center gap-0.5">
                      <span className="text-muted-foreground text-[9px] font-semibold leading-tight">TRABAJADOR</span>
                      <span className="font-medium text-[10px] leading-tight line-clamp-1">{note.workerName || 'Desconocido'}</span>
                    </div>
                    <div className="bg-muted/30 rounded px-2 grid min-h-[40px] place-content-center text-center gap-0.5">
