                ...
                <div className="space-y-1.5">
                  ...
                  <div className="grid grid-cols-3 gap-1 text-[10px]">
                    <div className="bg-muted/30 rounded grid min-h-[44px] grid-rows-[1fr_1fr] px-2">
                      ...
                      <span className="inline-flex items-center justify-center font-medium text-[10px] leading-none line-clamp-1">{note.clientName || 'N/A'}</span>
                    </div>
                    <div className="bg-muted/30 rounded grid min-h-[44px] grid-rows-[1fr_1fr] px-2">
                    ...
                    <div className="bg-muted/30 rounded grid min-h-[44px] grid-rows-[1fr_1fr] px-2">
                      <span className="inline-flex items-center justify-center text-muted-foreground text-[9px] font-semibold leading-none">TRABAJADOR</span>
                      <span className="inline-flex items-center justify-center font-medium text-[10px] leading-none line-clamp-1">{note.workerName || 'Desconocido'}</span>
                    </div>
                    <div className="bg-muted/30 rounded grid min-h-[44px] grid-rows-[1fr_1fr] px-2">
